...
const Data = {
    ...
    setDependentGeomParameters: function () {
		...
		const Xmin = Math.min(-1, -1 + this.controlsParameters.dx);
        const Xmax = Math.max( 1,  1 + this.controlsParameters.dx);
        const Ymin = Math.min(-1, -1 + this.controlsParameters.dy);
        const Ymax = Math.max( 1,  1 + this.controlsParameters.dy);
