...
async function main() {
	...
	guiSplineParams.add(Data.controlsParameters, 'coonsLinearSurface').onChange(function (e) { Data.calculateAndDraw(); });
...
const Data = {
    ...
    generateControlPoints: function () {
        ...
        if (this.controlsParameters.coonsLinearSurface)
